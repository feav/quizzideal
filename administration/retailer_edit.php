...
if (isset($_POST["action"]) && $_POST["action"] == "edit")
{
    ...
    if (!($rname && $url && $status))
    {
        $errors[] = "Veuillez vous assurer que tous les champs marqués d'un astérisque sont complets";
    }
    else
    {
        if ($img == "")
    ...
    if (count($errors) == 0)
    {
        ...
        header("Location: ". url_panel ."/retailers.php?msg=updated");
        exit();
    }
    else
    {
...
$title = "Mettre à jour le cashback";
require_once ("cashback/inc/header.inc.php");

?>

    <h2>Mettre à jour le Cashback</h2>
...
<?php if ($total > 0) {
    ...
    <div style="position: absolute; right: 10px; margin-top: 5px; padding: 5px;">
        <div align="right"><font color="red">* dénote le champ obligatoire</font></div><br/>
    ...
    <form action="" method="post" name="form1">
        <table bgcolor="#F9F9F9" width="100%" cellpadding="2" cellspacing="3"  border="0" align="center">
            ...
            <tr>
                <td valign="middle" align="right" class="tb1">Réseaux Affiliation:</td>
                <td valign="top">
            ...
            <tr id="program_id" <?php if ($row['network_id'] == 0 && !$_POST['action']) { ?>style="display: none;" <?php } ?>>
                ...
                <td valign="top"><input type="text" name="program_id" value="<?php echo $row['program_id']; ?>" size="21" class="textbox" /><span class="note">Identifiant marchand du réseau affilié</span></td>
            </tr>
            <tr>
                <td width="30%" valign="middle" align="right" class="tb1">Catégories:</td>
            ...
            <tr>
                <td valign="middle" align="right" class="tb1">Pays:</td>
                <td valign="top">
                    <div class="scrollbox">
                        <?php
            ...
            <tr>
                ...
                <td valign="middle"><input type="checkbox" class="checkbox" name="featured" value="1" <?php if ($row['featured'] == 1) echo "checked=\"checked\""; ?> />&nbsp;Oui!</td>
            </tr>
            <tr>
                <td valign="middle" align="right" class="tb1">Magasin de la semaine ?</td>
                <td valign="middle"><input type="checkbox" class="checkbox" name="deal_of_week" value="1" <?php if ($row['deal_of_week'] == 1) echo "checked=\"checked\""; ?> />&nbsp;Oui!</td>
            </tr>
            <tr>
            ...
            <tr>
                <td align="center" colspan="2" valign="bottom">
                    ...
                    <input type="submit" class="submit" name="update" id="update" value="Mise à jour cashback" />
                    <input type="button" class="cancel" name="cancel" value="Annuler" onClick="javascript:document.location.href='retailers.php?page=<?php echo $pn; ?>&column=<?php echo $_GET['column']; ?>&order=<?php echo $_GET['order']; ?>'" />
                </td>
            </tr>
        </table>
    </form>
...
<?php }else{ ?>
    <p align="center">Cashback introuvable<br/><br/><a class="goback" href="#" onclick="history.go(-1);return false;">Retour</a></p>
<?php } ?>
