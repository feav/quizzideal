...
<section class="bg-white absolute-section-1">
	<div class="m-auto content p-40-20">
		<div class="row">
			...
			<div class=" bg-white col-md-8 col-sm-12">
				<div class="bg-green color-white p-10-20 f-s-14 b-r-10 b-special-grey m-b-20">
					Informations
				</div>
				<div class="bg-light-grey b-r-10 p-20 b-special-grey">
						<form id="InfosForm" method="POST">
							...
							<div class="txt-align-center">
								...
								<button type="submit" name="submit_infos" value="submit_infos" class="button-blue-degrade color-white b-r-5 f-s-13 submit-md">Valider</button>
							</div>
						</form>
					</div>
			</div>
