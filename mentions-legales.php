...
.col-md-8.col-xs-12.f-s-14.f-w-light {
...
p {
    ...
    <div class="section-headline-wrap vb">
        <div class="section-headline">
            <h2>Mentions légales</h2>
            <p>Accueil<span class="separator">/</span><span class="current-section">Mentions-légales</span></p>
        </div>
    </div>
		...
		<section class="bg-light-grey absolute-section-1 margin-base">
			<div class="m-auto content p-40-20 container"><div class="row">
				...
				<div class="col-md-8 col-xs-12 f-s-14 f-w-light">
