...
<style>
    ...
    .toggle-wrap .trigger.active .title-item-faq{
        color: #f91942;
        font-size: 29px;
    }
    .toggle-wrap .trigger > a{padding-bottom: 3px}
    .toggle-container{padding-left: 15px!important;}
</style>
        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="style-2">
                ...
                <div class="toggle-wrap">
                    <span class="trigger"><a href="#"><h2 class="title-item-faq">Questions générales</h2><i class="sl sl-icon-plus"></i></a></span>
                ...
                <!-- Toggle 2 -->
                <div class="toggle-wrap">
                    <span class="trigger"><a href="#">Paiement<i class="sl sl-icon-plus"></i> </a></span>
                    <div class="toggle-container">
                ...
                <!-- Toggle 3 -->
                <div class="toggle-wrap">
                    <span class="trigger"><a href="#">Votre compte<i class="sl sl-icon-plus"></i> </a></span>
                    <div class="toggle-container">
                ...
                <!-- Toggle 4 -->
                <div class="toggle-wrap">
                    <span class="trigger"><a href="#">Missions<i class="sl sl-icon-plus"></i> </a></span>
                    <div class="toggle-container">
                ...
                <!-- Toggle 4 -->
                <div class="toggle-wrap">
                    <span class="trigger"><a href="#">Système d’acquisition de nouveaux membres<i class="sl sl-icon-plus"></i> </a></span>
                    <div class="toggle-container">
